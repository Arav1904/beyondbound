        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-2 xl:grid-cols-[1.25fr_1fr_1fr_1.15fr]">
          <div className="col-span-2 xl:col-span-1">
            <h3 className="text-lg font-semibold tracking-tight text-slate-100">
              BEYOND BOUND
              <sup className="relative -top-2 ml-1 text-[10px] font-medium">
                ®
              </sup>
            </h3>
            ...
            >
              ...
              <div className="px-5 pb-6 pt-4 sm:px-6 lg:px-8">
                ...
                <p className="mt-3 text-sm leading-relaxed text-slate-600 sm:text-base">
                  Welcome to Beyond Bound. This Payment Policy outlines the
                  terms and conditions related to payments made on our website
                  (www.beyondbound.info). By placing an order, you agree to the
                  terms mentioned below.
                </p>
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  <h5 className="text-sm font-semibold text-slate-800 sm:text-base">
                    1. Accepted Payment Methods
                  </h5>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    We offer secure and convenient payment options through our
                    payment partner PayU. Customers can complete transactions
                    using:
                  </p>
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    ...
                    payment gateways. Beyond Bound does not store any card or
                    payment details on its servers. Payments are handled by
                    trusted third-party providers to ensure safety and
                    compliance.
                  </p>
                </div>
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-slate-600 sm:text-base">
                    <li>
                      Once the payment is successfully completed, you will
                      receive an order confirmation via SMS/email.
                    </li>
                    <li>
                      If payment fails but the amount is debited, it is usually
                      reversed automatically within 5-7 working days by your
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-slate-600 sm:text-base">
                    <li>
                      All prices listed on the website are in INR (Rs.) and
                      inclusive/exclusive of applicable taxes (GST), as
                      mentioned.
                    </li>
                    <li>
                      Beyond Bound reserves the right to update pricing at any
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-slate-600 sm:text-base">
                    <li>
                      If your payment is unsuccessful, please retry after
                      checking your balance or payment method.
                    </li>
                    <li>
                      In case of double payment or technical errors, please
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-slate-600 sm:text-base">
                    <li>
                      ...
                      payment method within 7-10 working days after approval.
                    </li>
                    <li>
                      Refund eligibility depends on our Return &amp;
                      Cancellation Policy.
                    </li>
                  </ul>
                </div>
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-slate-600 sm:text-base">
                    ...
                    <li>
                      Once the order is shipped, cancellation may not be
                      possible.
                    </li>
                  </ul>
                </div>
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Beyond Bound reserves the right to cancel any order if fraud
                    or unauthorized activity is suspected. Necessary legal
                    action may be taken in such cases.
                  </p>
                </div>
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  <h5 className="text-sm font-semibold text-slate-800 sm:text-base">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Beyond Bound Support Team
                    <br />
                    Email: beyondbound889@gmail.com
                    <br />
                    Phone: +91 6396190643
                  </p>
                  <p className="mt-3 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Note: By making a payment on our website, you agree to abide
            ...
            >
              ...
              <div className="px-5 pb-6 pt-4 sm:px-6 lg:px-8">
                ...
                <section className="mt-4" aria-labelledby="terms-conditions">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Welcome to BeyondBound. These Terms and Conditions outline
                    the rules and regulations for the use of BeyondBound's
                    website. By accessing this website, we assume you accept
                    these terms and conditions in full. Do not continue to use
                    BeyondBound's website if you do not accept all of the terms
                    and conditions stated on this page. This website is managed
                    by AYURHELIX PRIVATE LIMITED.
                  </p>
                </section>

                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  <h6 className="text-sm font-semibold text-slate-800 sm:text-base">
                    1. Intellectual Property Rights
                  </h6>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Unless otherwise stated, BeyondBound and/or its licensors
                    ...
                    https://www.beyondbound.info/ for your own personal use
                  ...
                  <ul className="mt-2 list-disc space-y-1.5 pl-5 text-sm text-slate-600 sm:text-base">
                    ...
                    <li>
                      Redistribute content from BeyondBound (unless content is
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    ...
                    display on this website. By displaying Your Content, you
                    grant BeyondBound a non-exclusive, worldwide, irrevocable,
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    ...
                    any third party's rights. BeyondBound reserves the right to
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Please refer to our Privacy Policy below for information on
                    how we collect, use, and disclose information from our
                    users. Your use of the website signifies your acknowledgment
                    of and agreement to our Privacy Policy.
                  </p>
                </div>
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    In no event shall BeyondBound, nor any of its officers,
                    ...
                    otherwise. BeyondBound, including its officers, directors,
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    You hereby indemnify to the fullest extent BeyondBound from
                    and against any and all liabilities, costs, demands, causes
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    BeyondBound is permitted to revise these Terms at any time
                    as it sees fit, and by using this website you are expected
                    to review such Terms on a regular basis to ensure you
                    understand all terms and conditions governing the use of
                    this website.
                  </p>
                </div>
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    ...
                    with the laws of the jurisdiction in which BeyondBound
                    operates, and you submit to the non-exclusive jurisdiction
                    of India.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    At BeyondBound, accessible from
                    https://www.beyondbound.info/, one of our main priorities is
                    the privacy of our visitors. This Privacy Policy document
                    contains types of information that is collected and recorded
                    by BeyondBound and how we use it.
                  </p>
                </section>
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Direct Information: If you contact us directly via our email
                    (official@beyondbound.info), we may receive additional
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Account Information: If you register for an account, we may
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    BeyondBound follows a standard procedure of using log files.
                    These files log visitors when they visit websites. The
                    information collected by log files includes internet
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    Like any other website, BeyondBound uses "cookies". These
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    BeyondBound's Privacy Policy does not apply to other
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  <h6 className="text-sm font-semibold text-slate-800 sm:text-base">
                    6. GDPR Data Protection Rights (For EU Users)
                  </h6>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    ...
                    guide their online activity. BeyondBound does not knowingly
                ...
                <div className="mt-5 border-t border-slate-200/80 pt-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
                    We do not provide any kind of refund due to the nature of
                    business.
                  </p>
                </div>
                ...
                <div className="mt-6 border-t border-slate-200/80 pt-4">
                  <label className="flex items-start gap-3 text-sm text-slate-600 sm:text-base">
                    ...
                    />
                    <span>
                      I have read and accept the Terms and Conditions and
                      Privacy Policy.
                    </span>
                  </label>
                </div>
